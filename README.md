...
- Figura 3 – Sites brasileiros quanto à frequência de alteração do conteúdo.
- Figura 4 – Os três gráficos (1), (2) e (3) mostram, de forma ilustrativa, a necessidade de aplicação de três tarefas diferentes de PLN T1, T2 e T3. T2 só consegue 90% de acerto de melhorar T1 e T3.
